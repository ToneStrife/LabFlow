...
const Accounts = () => {
  ...
  const handleAddAccount = async (newAccountData: CustomerAccountFormValues) => {
    ...
    await addCustomerAccountMutation.mutateAsync({ data: newAccountData, ownerId: session.user.id });
    setIsAddAccountDialogOpen(false);
  };

  const handleEditAccount = async (accountId: string, updatedData: CustomerAccountFormValues) => {
    await updateCustomerAccountMutation.mutateAsync({ id: accountId, data: updatedData });
          ...
          {editingAccount && (
            <CustomerAccountForm
              initialData={{
                ...
                assignedManagerId: editingAccount.assigned_manager_id || undefined,
              }}
