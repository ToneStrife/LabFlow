...
import MergeRequestsDialog from "@/components/MergeRequestsDialog"; // Importar Merge Dialog
import { useShippingAddresses, useBillingAddresses } from "@/hooks/use-addresses";
import ApproveRequestListDialog from "@/components/request-list/ApproveRequestListDialog"; // Importar el nuevo diálogo
...
const RequestList: React.FC = () => {
  ...
  // Nuevos estados para el diálogo de aprobación en la lista
  ...
  // NUEVO: Handler para abrir el diálogo de aprobación desde la lista
  ...
  // NUEVO: Handler para "Aprobar Solamente" desde la lista
  ...
  // NUEVO: Handler para "Aprobar y Enviar Correo" desde la lista
  ...
  return (
    <div className="space-y-4">
      ...
      {/* NUEVO: Diálogo de Aprobación desde la lista */}
